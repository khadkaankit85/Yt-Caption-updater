...
const oAuth2Client = new OAuth2Client(process.env.YOUTUBE_V3_CLIENT_ID, process.env.YOUTUBE_V3_CLIENT_SECRET, process.env.YOUTUBE_V3_REDIRECT_URI);
...
async function getValidCategories(service) {
...
async function updateVideoTitle(service, videoId, newTitle, categoryId) {
